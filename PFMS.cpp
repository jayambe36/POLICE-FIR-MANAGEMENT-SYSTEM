...
class FIR	//class FIR
{
	...
	public:
		void add() //add() to add record in data base
		{
			...
			label1:cout << endl << "\t\tEnter CONVICT First Name           : ";	cin >> name;
			geng:cout << "\t\tEnter Gender of CONVICT            : "; cin >> gen;
			cout<<"  \t\tEnter Age of CONVICT               : "; cin >> age;
			cout << "\t\tEnter Weight of  CONVICT           : "; cin >> weight;
			cout << "\t\tEnter Height of CONVICT (in feets) : "; cin >> height;
			cout << "\t\tEnter Hair Color of CONVICT        : "; cin >> hair_color;
			cout << "\t\tEnter Eyecolor of CONVICT          : "; cin >> eye_color;
    	    cout << "\t\tEnter Type Crime by CONVICT        : "; cin >> crime;
			cout << "\t\tEnter Court No of CONVICT          : "; cin >> court_no;
			cout << "\t\tEnter Act No of CONVICT            : "; cin >> act_no;
    	    cout << "\t\tEnter City of crime by CONVICT     : "; cin >> address;
			cout << "\t\tEnter FIR number of the CONVICT    : " ; cin >> fir_no;
			cout << "\t\tEnter Contact number of CONVICT    : "; cin >> emer_con;
			cout << "\t\tEnter Relation contact of CONVICT  : "; cin >> relation;
			cout << "\t\tEnter Date (format:YYYYMMDD)       : " ; cin >> date;
		...
		void modify() //modify() to modify CONVICT details
		{
			...
			cin >> fir_no;
			label1:cout << endl << "\t\tEnter correct First Name OF CONVICT          : "; cin >> name;
			cout << "\t\tEnter correct Gender of CONVICT            : "; cin >> gen;
			cout << "\t\tEnter correct Age of CONVICT               : "; cin >> age;
			cout << "\t\tEnter correct Weight of CONVICT            : "; cin >> weight;
			cout << "\t\tEnter correct Height of CONVICT (in feets) : "; cin >> height;
			cout << "\t\tEnter correct Hair Color of CONVICT        : "; cin >> hair_color;
			cout << "\t\tEnter correct Eyecolor of CONVICT          : "; cin >> eye_color;
			cout << "\t\tEnter correct Type Crime by CONVICT        : "; cin >> crime;
			cout << "\t\tEnter correct Court No of CONVICT          : "; cin >> court_no;
			cout << "\t\tEnter correct Act No of CONVICT            : "; cin >> act_no;
			cout << "\t\tEnter correct city of crime by CONVICT     : "; cin >> address;
			cout << "\t\tEnter correct Contact number of CONVICT    : "; cin >> emer_con;
			cout << "\t\tEnter correct Relation contact of CONVICT  : "; cin >> relation;
			cout << "\t\tEnter Date (YYYYMMDD)                      : "; cin >> date;
...
int main()
{
	...
	cout << endl << endl << "\t\t Enter Username : "; cin >> u_name;
	...
	if(u_name == "QWERTY") //checking username
	{
		...
		{
			cout << endl << "\t\tWrong password.";	a = a + 1;
			cout << endl << "\t\tPress any key to continue...";
			char c;
			cin >> c;
			goto start;
	...
	{
		cout << endl << "\t\tWrong username."; a = a + 1;
		cout << endl << "\t\tPress any key to continue.......";
		char c;
		cin >> c;
		goto start;
